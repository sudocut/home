...
- We use it to create and identify your account, and to contact you about the
  service.
- **We do not request access to Gmail, Google Drive, YouTube or any other Google
  service, and we cannot read them.**
- We do not sell it, do not use it for advertising, and do not share it with
  anyone other than the providers in section 4.
...
| --- | --- |
| Google (Sign-In, Forms) | Sign-in identity; waitlist submissions |
...
section 2, for as long as section 6 describes. If you do not want that, do not
