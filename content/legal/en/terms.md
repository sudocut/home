...
**company.sudo-cut.com**, and the closed-beta waitlist. "SudoCut", "we" and "us"
mean the company operating the service from the United States; "you" means
the person or organisation using it.

By signing in, uploading footage, or joining the waitlist, you accept these
terms. If you do not accept them, do not use the service.

## 1. The closed beta

SudoCut is an invite-only closed beta, and everything below follows from that.
...
- We may end the beta, or your place in it, at any time. If we end the beta
  itself, we will give you a reasonable period to download your projects and
  exports first.

## 2. Your account

- You sign in with a Google account. What we receive from Google is described in
  the [Privacy Policy](/en/privacy).
- An account is for one person. Do not share your sign-in.
- You must be at least 14 years old. If you are under 18, you need a parent's or
  legal guardian's consent to use the service.
- You are responsible for what happens under your account.

## 3. Your footage stays yours

You keep every right you already had in the footage you upload and in the cuts,
subtitles, project files and exports SudoCut produces from it. We claim no
ownership of any of it.

To run and improve the service, you grant us a limited licence to store, copy,
transcode, transcribe and analyse your media, and to generate cuts, subtitles,
previews, project files and exports from it. The licence is limited to operating
and improving SudoCut, and it ends for a given file when that file is deleted.

Where and how that material is stored, who processes it with us, and what else
we use it for are set out in the [Privacy Policy](/en/privacy).

If we ever want to show your work — a clip in a demo, your channel's name as a
beta user — we will ask you first, every time.

## 4. What you upload

By uploading, you confirm that:

- you hold the rights to the footage, audio and any music in it;
- where consent is needed, the people who appear or speak in it have given it;
- uploading it breaks no law and no agreement you are under.

Do not upload content that is illegal in the United States or where you are,
sexual content
involving minors, material created to harass a person, or anything you do not
hold the rights to.
...
- Joining the beta credits you **600 raw minutes** (10 hours).
- Top-ups are one-time credit packs at **₩100 per raw minute**. Prices are in
  KRW.
- Re-processing the same source does not cost credits again.
- Credits are a right to use the service. They are not money, not transferable
  and not exchangeable for cash.
- Credits are not refundable, except where the law of your country requires it.
  If a job fails because of a fault on our side, write to
  <support@sudo-cut.com> and we will look at it.
...
the service will be uninterrupted, that a cut will be correct, or that a
transcript will be accurate.
...
paid us in the six months before the claim arose — which, during a free beta,
may be nothing.
...
We may suspend or end your access if you break these terms, if we are legally
