...
/**
 * Front page — r6 variant BREATHE.
 *
 * The dot pitch swings — the screen breathes between fine and coarse, so the
 * field resolves and dissolves as a picture without anything moving across it.
 * The slider sets the centre of the swing rather than a fixed value.
 *
 * The risk, and it is the one to watch when ranking: this is the only motion in
 * the round with no meaning behind it. A pan is a playhead and a cut is an edit;
 * a breath is decoration, which is the thing soul.md keeps telling us to remove.
 *
  ...
  return (
    <>
      <ScreenStage
        ...
        consoleClass="sc-console-wrap--center"
