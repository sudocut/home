...
/**
 * Front page — r6 variant DRIFT.
 *
 * The most restrained of the six, and the control against the other five. A
 * slow ambient drift, a fine 12px screen, and a single slider.
 *
 * It exists to answer the question the round would otherwise beg: whether all
 * this movement and interface beats a page that does almost none of it. If
 * drift wins, that is a real result and not a boring one.
 *
