...
/**
 * Front page — r6 variant CONSOLE.
 *
 * The console is the feature, not a footnote. Every parameter the visitor is
 * allowed to touch is on the page, boxed beside the claim.
 *
 * The argument for it is not novelty. soul.md S7 is "expose the criteria —
 * reviewable, never a black box", and it is the same instinct that puts every
 * cut on an editable timeline. A front page that hands over its own controls is
 * making that argument in the only way a landing page can.
 *
 * The risk: five controls beside a three-sentence claim is a lot of interface
 * for a page whose brief was "too much text". Interface is text.
 *
  ...
  return (
    <>
      <ScreenStage
        ...
        consoleClass="sc-console-wrap--panel"
        layout="split"
        controls={["pitch", "contrast", "motion", "grid", "source"]}
        motion="drift"
        pitch={18}
