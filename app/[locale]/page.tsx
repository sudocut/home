...
/**
 * Front page — r6 variant CUTDEMO.
 *
 * The background IS the demo. Every 2.6 seconds it hard cuts between the
 * recording and the same recording with its dead air removed — 26.2% of it,
 * measured by the generator that built both images from one signal.
 *
 * That is the product, stated without a sentence. The two images come from
 * index-remapping the same envelope rather than being drawn twice, so the cut
 * is provably the same audio; two separately generated waveforms would have
 * made the swap a lie about what changed.
 *
 * The source toggle lets a visitor stop the cycle and hold either state.
 *
